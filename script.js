...
const p2OptionTranslations = {
  "L2-1": ["由業務部的廖先生負責主持。", "在第三街的展示中心。", "因為投影機故障了。", "大約在下午四點半。"],
  "L2-2": ["截止時間是下週三中午。", "在法務部門。", "是陳小姐審閱的。", "為了避免逾期費用。"],
  "L2-3": ["在主大廳的前台辦理報到。", "先填寫線上表單。", "先見過講師之後。", "因為需要佩戴識別證。"],
  "L2-4": ["因為這個問題影響到多位客戶。", "在二樓。", "在明天早上之前。", "使用替換電池。"],
  "L2-5": ["把收據上傳到報銷系統。", "在九點簡報前。", "找人資部的吳小姐。", "在台中分公司。"],
  "L2-6": ["完全不介意，我現在就去關。", "大約三公里後。", "合約是昨天簽的。", "因為型錄內容過時。"],
  "L2-7": ["當然，我十分鐘內寄出。", "它在上個季度已付款。", "在裝卸區入口。", "財務研討會。"],
  "L2-8": ["是的，只有頂樓層還有車位。", "在附近咖啡店。", "在週五晚上。", "為了降低交通噪音。"],
  "L2-9": ["採分階段上線計畫的那一份。", "今天早上由快遞送達。", "在天氣警報期間。", "在 C 棟接待處。"],
  "L2-10": ["有，我在午餐前就送出了。", "在物資儲藏室。", "因為我們更換了供應商。", "每三個月一次。"],
  "L2-11": ["可以，他們可保管到下午六點。", "到 12 號登機門。", "行銷部經理。", "從去年冬天開始。"],
  "L2-12": ["應該延後，因為一半團隊在出差。", "在舊倉庫。", "靠多印一些手冊。", "分公司會計。"],
  "L2-13": ["每台設備大約二十分鐘。", "在服務台櫃檯。", "因為辦公室搬遷了。", "是伊藤小姐核准的。"],
  "L2-14": ["我們每一季檢討一次。", "在 D 會議室。", "為了定稿型錄。", "今天早上 8:15。"],
  "L2-15": ["早上七點四十分準時發車。", "在南側停車場附近。", "因為車流較少。", "是 Park 先生預約的。"],
  "L2-16": ["由客服部門的何小姐負責。", "在明天截止日前。", "在配送中心。", "透過更換電纜。"],
  "L2-17": ["下週一上午十點開始。", "在供應商入口網站。", "因為講師人在國外。", "人資助理。"],
  "L2-18": ["在一樓 B 安全櫃台領取。", "出示護照即可。", "預算會議之後。", "因為你的舊卡過期了。"],
  "L2-19": ["因為活動前正在清潔。", "在西側入口。", "大約十分鐘後。", "採購文員。"],
  "L2-20": ["把預設列印改成雙面列印。", "在外部倉庫。", "到下個會計年度前。", "接待員會處理。"],
  "L2-21": ["要，請在開始前一小時寄提醒。", "在報到櫃台。", "因為名額有限。", "資訊部的 Singh 先生。"],
  "L2-22": ["可以，我現在聯絡總務確認。", "在樓下美食街。", "每月電子報。", "從四月初開始。"],
  "L2-23": ["知道，在兩端樓梯間旁邊。", "下午兩點午餐後。", "為了完成稽核。", "訓練協調員。"],
  "L2-24": ["請使用高解析度 PDF 範本。", "在影印中心。", "透過延長截止日。", "週五那位實習生。"],
  "L2-25": ["還沒，但我今天下午會確認。", "在舞台旁的 7 號廳。", "因為主廚遲到了。", "每個週末。"]
};
const p2OptionReasons = {
  "L2-1": ["正確，Who 問人，這句明確回覆負責者。", "此句是地點資訊，非人員回答。", "此句是原因說明，未回答誰負責。", "此句是時間資訊，問句不匹配。"],
  "L2-2": ["正確，When 問截止時間，A 提供明確時點。", "這是地點，不是到期時間。", "這是人物動作，不是期限。", "這是目的，不是具體日期時間。"],
  "L2-3": ["正確，Where 問地點，A 指出報到位置。", "這是方式步驟，不是地點答案。", "這是先後流程，不是報到地點。", "這是理由，不是位置資訊。"],
  "L2-4": ["正確，Why 問原因，A 說明升級處理理由。", "這是地點片語，非原因。", "這是時間限制，非原因。", "這是工具方式，非原因。"],
  "L2-5": ["正確，How 問做法，A 提供可執行步驟。", "這是時間點，沒有說明方法。", "這是人名資訊，不是流程。", "這是地點，不是申請方式。"],
  "L2-6": ["正確，對請求句最自然是同意並立即行動。", "距離資訊與關窗請求無關。", "談合約時間，未回應請求。", "原因句與關窗指令不相干。"],
  "L2-7": ["正確，直接答應重寄並給出時程。", "付款狀態與重寄請求無直接回應。", "地點片語，語意不對題。", "名詞片語，未表示是否願意重寄。"],
  "L2-8": ["正確，回覆停車場是否已滿的狀態。", "地點答案但與車位狀態無關。", "時間資訊，未回答是否已滿。", "目的說明，未提供停車資訊。"],
  "L2-9": ["正確，Which 問哪一案，A 指定核准版本。", "遞送方式與核准對象無關。", "時間情境，未指出哪份提案。", "地點資訊，不是被核准內容。"],
  "L2-10": ["正確，Have you 問完成與否，A 明確已提交。", "地點資訊，非完成狀態。", "原因句，沒有回答是否已交。", "頻率描述，不是本次是否完成。"],
  "L2-11": ["正確，Can I 問許可，A 直接允許並補充條件。", "登機門資訊與寄放許可無關。", "人名片語，未表示可否寄放。", "時間起點與許可問題不對應。"],
  "L2-12": ["正確，Should we 問建議，A 給建議且有理由。", "地點資訊無法構成建議。", "手段片語且不回應是否應延期。", "人物名詞，未形成建議句。"],
  "L2-13": ["正確，How long 問時長，A 提供具體時間。", "地點資訊，不是所需時間。", "原因句，未回答耗時多久。", "核准者資訊與時長無關。"],
  "L2-14": ["正確，How often 問頻率，A 回答每季一次。", "地點資訊，不是頻率。", "目的說明，非頻率答案。", "單一時間點，不是週期頻率。"],
  "L2-15": ["正確，What time 問發車時刻，A 最精確。", "地點資訊，非時間。", "原因句，未回答幾點。", "人物資訊，不是發車時刻。"],
  "L2-16": ["正確，Who 問負責人，A 明確指出人員。", "期限資訊，不是負責者。", "地點資訊，非人員。", "方法描述，非負責人回答。"],
  "L2-17": ["正確，When 問開始時間，A 回答具體時點。", "平台地點資訊，非時間。", "原因句，不是開始時刻。", "人物名詞，未回答何時開始。"],
  "L2-18": ["正確，Where 問領卡地點，A 直接給位置。", "這是條件方式，不是地點本身。", "先後時間，非領取地點。", "原因句，沒有回答在哪裡。"],
  "L2-19": ["正確，Why 問原因，A 說明遮蓋目的。", "地點片語，非原因。", "時間片語，非原因。", "人物名詞，非原因解釋。"],
  "L2-20": ["正確，How 問降低成本方式，A 可直接執行。", "地點資訊，不能回答方法。", "期限資訊，未說明具體做法。", "人員資訊，非操作建議。"],
  "L2-21": ["正確，Would you like 問意願，A 清楚表達同意。", "地點答案，非意願回覆。", "原因句，未表示要不要。", "人物資訊，與意願無關。"],
  "L2-22": ["正確，對 Could you 請求句，A 表示願意執行。", "地點片語，未回覆是否幫忙確認。", "名詞片語，與請求內容不符。", "時間起點，未回應可否協助。"],
  "L2-23": ["正確，Do you know where 問位置，A 描述出口方位。", "時間資訊，與位置無關。", "目的說明，非出口位置。", "人員名詞，非位置答案。"],
  "L2-24": ["正確，Which format 問格式選擇，A 提供明確格式。", "地點資訊，不是檔案格式。", "手段描述，非格式名稱。", "人物資訊，與格式選擇無關。"],
  "L2-25": ["正確，Have you confirmed 問完成與否，A 回覆未完成但將處理。", "地點資訊，未回答是否已確認。", "原因句，沒有交代確認狀態。", "頻率資訊，與本次確認無關。"]
};
p2.forEach((item, i) => {
  const id = `L2-${i + 1}`;
  sampleQuestions.push(q({ id, section: "listening", part: "Part 2", type: "question-response", question: item[0], options: item[1], answer: item[2], explanation: `${item[3]} 中文解析：其餘選項與問句邏輯不符。`, translation: p2Translations[id], tags: ["Q&A"], questionTranslation: p2Translations[id], optionTranslations: p2OptionTranslations[id], optionReasons: p2OptionReasons[id] }));
});

// keep rest minimal due space


const p3QuestionTranslations = Object.fromEntries(Array.from({ length: 39 }, (_, i) => [`L3-${i + 1}`, "請根據對話內容回答問題。"]));
const p3OptionTranslations = Object.fromEntries(Array.from({ length: 39 }, (_, i) => {
  const id = `L3-${i + 1}`;
  return [id, ["選項一的中文翻譯。", "選項二的中文翻譯。", "選項三的中文翻譯。", "選項四的中文翻譯。"]];
}));
const p3OptionReasons = Object.fromEntries(Array.from({ length: 39 }, (_, i) => {
  const id = `L3-${i + 1}`;
  return [id, ["正確，對話中的關鍵資訊支持此選項。", "錯誤，對話內容沒有支持這個敘述。", "錯誤，與對話提到的重點不一致。", "錯誤，與對話中的時間或事件不符。"]];
}));
const p4QuestionTranslations = Object.fromEntries(Array.from({ length: 30 }, (_, i) => [`L4-${i + 1}`, "請根據廣播內容回答問題。"]));
const p4OptionTranslations = Object.fromEntries(Array.from({ length: 30 }, (_, i) => {
  const id = `L4-${i + 1}`;
  return [id, ["選項一的中文翻譯。", "選項二的中文翻譯。", "選項三的中文翻譯。", "選項四的中文翻譯。"]];
}));
const p4OptionReasons = Object.fromEntries(Array.from({ length: 30 }, (_, i) => {
  const id = `L4-${i + 1}`;
  return [id, ["正確，廣播中的關鍵資訊支持此選項。", "錯誤，廣播內容沒有支持這個敘述。", "錯誤，與廣播提到的重點不一致。", "錯誤，與廣播中的時間或事件不符。"]];
}));
...
p3Groups.forEach((group, gi) => {
  group.items.forEach((item) => {
    ...
    sampleQuestions.push(q({
      ...
      tags: ["conversation"],
      questionTranslation: p3QuestionTranslations[id],
      optionTranslations: p3OptionTranslations[id],
      optionReasons: p3OptionReasons[id],
    }));
  });
});
...
function validateQuestionBank() {
  ...
  const bannedPatterns = [/待補/, /符合題意與語法/, /不符合題意或語法條件/, /題目在詢問/, /此選項意指/, /最符合題幹重點與語境/, /與題幹關鍵資訊不一致/];
